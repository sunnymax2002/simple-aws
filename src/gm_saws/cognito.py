# Source derived and modified from AWS example

# REF: https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/python/example_code/cognito/cognito_idp_actions.py#L52
...
class CognitoIdentityProviderWrapper:
    ...
    def sign_up_user(self, user_name, password, user_email, additional_signup_attributes: dict):
        """
        ...
        """
        try:
            user_attrs = [{"Name": "email", "Value": user_email}] + [{'Name': k, 'Value': v} for k,v in additional_signup_attributes.items()]
            kwargs = {
    ...
    def get_user_info(self, user_name):
        """Fetches user attributes, this should be called only if sign_in is successful"""
